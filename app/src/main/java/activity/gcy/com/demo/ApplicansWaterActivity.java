    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(str<Float.parseFloat(tips)||str>100){
                    Toast.makeText(ApplicansWaterActivity.this, "设置的水温度需高于环境温度且小于100!", Toast.LENGTH_SHORT).show();
                    return;
                }else{
                    new Thread(new HttpThread("water "+str)).start();
